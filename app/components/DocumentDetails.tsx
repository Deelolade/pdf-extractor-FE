      ...
      group-hover:opacity-100 group-hover:scale-100">Change title</span>
                    ...
                    <div className="mt-12">
                        <div className=" flex flex-col mx-auto items-center ">
                            <div className="  flex flex-col lg:flex-row justify-between items-start gap-3 lg:items-center w-full ">
                            ...
                            <div className="flex flex-wrap xxs:flex-col justify-center sm:flex-row items-center  gap-3 mt-6">
                                <button

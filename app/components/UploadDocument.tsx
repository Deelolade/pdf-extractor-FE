...
const UploadDocument = () => {
    ...
    return (
        <div className="">
            {loading && <Loading />}
            <label className=" m-3 relative block border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-slate-900 transition-colors duration-500 bg-gray-50 hover:bg-blue-50 cursor-pointer">
                <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Drag and drop your PDF files here, or click to browse and upload for analysis.
                        </p>
                    </div>
